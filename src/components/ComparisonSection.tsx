  ...
  const services: Service[] = [
    {
      ...
      description:
        "From single-family homes to multi-unit buildings, we provide safe and efficient residential demolition services. Our team handles everything from permits to final site cleanup.",
      buttonText: "RESIDENTIAL SERVICES",
      image: "/photos/homepage/1.jpg",
      orientation: "right",
      url: "/services/residential-demolition",
    },
    {
      title: "COMMERCIAL DEMOLITION",
      description:
        "Our commercial demolition services are designed for businesses and developers. We handle large-scale projects with minimal disruption to surrounding areas and businesses.",
      buttonText: "COMMERCIAL SERVICES",
      image: "/photos/homepage/2.jpg",
      orientation: "left",
      url: "/services/commercial-demolition",
    },
    {
      title: "SELECTIVE DEMOLITION",
      description:
        "When you need to preserve certain parts of a structure while removing others, our selective demolition service is the perfect solution. We carefully remove specific areas while protecting the rest.",
      buttonText: "SELECTIVE SERVICES",
      image: "/photos/homepage/3.jpg",
      orientation: "right",
      url: "/services/selective-demolition",
    },
    {
      title: "SITE CLEARING",
      description:
        "We provide comprehensive site clearing services, including tree removal, debris clearing, and site preparation for new construction. Our team ensures your site is ready for the next phase.",
      buttonText: "SITE SERVICES",
      image: "/photos/homepage/4.jpg",
      orientation: "left",
      url: "/services/site-clearing",
    },
  ];
  ...
  const ServiceCard: React.FC<ServiceCardProps> = ({ service }) => (
    ...
    >
      ...
      <div className="w-full md:w-1/2 px-6">
        <h2 className="text-4xl font-bold mb-6 tracking-wide text-[#2C3E50]">
          {service.title}
        </h2>
        <p className="text-lg text-[#5D6D7E] mb-8 leading-relaxed">
          {service.description}
        </p>
        <a
          href={service.url}
    ...
    <div>
      ...
      <div className="bg-gradient-to-b from-[#2C3E50] to-[#1a2530] w-full p-8 space-y-6">
        <h1 className="text-3xl md:text-4xl font-bold text-white text-center mb-8">
          Toronto&apos;s Premier Demolition Company
        </h1>

        <div className="flex justify-center">
          <svg
            className="w-16 h-16 mb-6 text-[#E74C3C]"
            viewBox="0 0 24 24"
            fill="currentColor"
          >
        ...
        {mounted && (
          <button
            onClick={() => copyToClipboard("6476974584", true)}
        ...
        <h2 className="text-xl md:text-2xl text-[#BDC3C7] text-center mb-6">
          Contact Us for a Professional Demolition Consultation
        </h2>
        ...
        {mounted && (
          <div className="flex justify-center">
            <button
              onClick={() =>
                copyToClipboard("office@toronto-demolition.com", false)
              }
              className={`${
                copiedEmail
      ...
      <section className="py-16 px-5 bg-[#F5F5F0]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            <h1 className="text-5xl font-bold mb-6 text-[#2C3E50]">
              OUR SERVICES
            </h1>
            ...
            <p className="max-w-3xl mx-auto text-lg text-[#5D6D7E] leading-relaxed">
              With over 15 years of experience, we deliver professional
              demolition services for both residential and commercial
              properties. Our certified team ensures safe, efficient, and
              environmentally responsible demolition using state-of-the-art
              equipment and industry-leading techniques.
            </p>
          </div>
