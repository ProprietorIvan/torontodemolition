...
const ResidentialDemolition = () => {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    projectDetails: "",
    email: "",
    formType: "residential-demolition",
  });
  ...
  const serviceFeatures = [
    {
      ...
      description: "Your local residential demolition specialists",
    },
    {
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center py-16">
            <div className="w-full md:w-1/2">
              ...
              <p className="text-xl text-[#5D6D7E] mb-8 leading-relaxed">
                Toronto&apos;s trusted residential demolition specialists. From
                single-family homes to multi-unit buildings, we handle it all.
              </p>
            ...
            {[
              {
                ...
                answer:
                  "The duration varies depending on the size and complexity of the project. A typical single-family home demolition can take 1-2 days, while larger properties may take several days.",
              },
              {
