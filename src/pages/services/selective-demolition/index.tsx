  ...
  const serviceFeatures = [
    {
      ...
      description: "Your local selective demolition specialists",
    },
    {
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center py-16">
            <div className="w-full md:w-1/2">
              ...
              <p className="text-xl text-[#5D6D7E] mb-8 leading-relaxed">
                Toronto&apos;s trusted selective demolition specialists. From
                interior walls to complete room removal, we handle it all.
              </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-6">
            {[
              {
                question: "How long does selective demolition typically take?",
                answer:
                  "The duration varies depending on the scope of work. A typical room removal can take 1-2 days, while larger selective demolition projects may take several days to a week.",
              },
              {
...
export default SelectiveDemolition;
