...
const WhyChooseUs = () => {
  const solutions = [
    {
      ...
      description:
        "Get repair estimates within minutes by uploading a photo – no in-person visits required.",
      icon: Camera,
    },
    {
    ...
    },
    {
      ...
      description:
        "Our handymen are licensed, insured, and thoroughly background-checked.",
      icon: Shield,
    },
    {
      title: "Progress Tracking",
      description:
        "Receive real-time updates, photos, and notifications as your project progresses.",
      icon: Activity,
    },
    {
      title: "Satisfaction Guarantee",
      description:
        "Not happy with the results? We'll fix it or refund your money – no questions asked.",
      icon: ThumbsUp,
    },
  ];
  ...
  const steps = [
    ...
    },
    {
      ...
      description:
        "Our AI analyzes your request and provides an accurate estimate within minutes.",
    },
    {
      number: "3",
      title: "Book Online",
      description:
        "Choose a time slot that works best for you from our real-time availability calendar.",
    },
    {
      number: "4",
      title: "Get It Fixed",
      description:
        "A vetted handyman will arrive on time and complete the repair professionally.",
    },
  ];
